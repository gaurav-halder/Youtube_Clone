  ...
  return (
    <div className='grid grid-flow-col px-4 '>
        ...
        <div className='flex items-center col-span-10 text-center justify-center'>
            ...
            <button className='border border-gray-300 p-2 px-4 rounded-r-full bg-gray-100'><CiSearch size={24}/></button>
            <button className=' rounded-full mx-4 p-2 bg-gray-100'><MdMic size={23}/></button>
        </div>
        <div className='flex col-span-1 items-center justify-end'>
            <button className='p-1.5 px-4'><MdOutlineVideoCall size={28}/></button>
            <button className='p-1.5'><IoIosNotificationsOutline size={28} /></button>
            <img className='h-8 px-4 cursor-pointer' alt="user-icon" src="https://www.iconpacks.net/icons/2/free-user-icon-3296-thumb.png"/>
        </div>
    </div>
  )
}
